...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/plaid-ios-link/Resources.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/plaid-ios-sdk/PLDResources.bundle"
fi
